/* Bantam Java Compiler and Language Toolset.
   ...
   Added a new field MIDI_CALL which can be used to generate 
   a SysCall in MIPS with no side effects (no additional lines of code
   are added)
   
   Modified the textStart() and dataStart() methods to remove
   Bantam Java specific functions to be more inline and optimized
   for Cymbal compilation
...
public class MipsSupport {
     ...
     * MIDI syscall
     */
    public final int MIDI_CALL = 999;
...
//        }
    ...
    /**
     * Generate a conditional branch
     * branches if first operand is less than to second operand
     *
     * @param reg1  first register to compare
     * @param reg2  second register to compare
     * @param label label to branch to
    ...
    /**
     * Generate a conditional branch
     * branches if first operand is less than  or equal second operand
     *
     * @param reg1  first register to compare
     * @param reg2  second register to compare
     * @param label label to branch to
    ...
    public void genSyscall(int syscallId) {
        ...
        //Syscall without side effects
        else if (syscallId == MIDI_CALL) {
        }
        else {
